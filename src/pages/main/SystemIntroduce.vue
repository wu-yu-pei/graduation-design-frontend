  ...
  <div class="system-introduce">
    ...
    <el-card class="box-card">
      ...
      <div class="content two">
        ...
        指导教师：赵景海 <br />
        日期：2023-1-3 <br />
        内容：随着科技的发展和人们生活质量的提高，生活中有数不胜数的物流信息，为了统一管理物流信息，为此设计了一套物流系统。系统的设计目标是基于javascript gl api实现一个物流发布及管理的可视化物流追踪系统，达到实时追踪物流，实时显示物流运输流向和数量分布，动态分析物流流向数据的效果。
        使用者录入信息后即可使用账号密码登陆物流追踪系统，可以对自己的所有物流数据进行统一管理，系统会把所有物流数据进行可视化展示让使用者对自己的物流有更加详细的认知。另外该系统使用过程中需要第三方物流公司配合才能达到实时的效果，本课题会设计一个专门的物流更新系统来达到实时的效果。
      </div>
    </el-card>
    <el-card class="box-card">
      <template #header>
